...
function fluida_get_option_defaults() {
	...
	"fluida_lpsliderimage"		=> get_template_directory_uri() . '/resources/images/slider/sky.jpg', // static image
	...
	"fluida_lpblockoneicon"		=> 'thumbs-up',
	"fluida_lpblocktwo"			=> $sample_pages[2],
	"fluida_lpblocktwoicon"		=> 'lightbulb',
	"fluida_lpblockthree"		=> $sample_pages[3],
	"fluida_lpblockthreeicon"	=> 'paper-plane-empty',
	...
	"fluida_lpboxheight1"		=> 200, // pixels
