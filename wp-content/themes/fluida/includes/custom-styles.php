...
.fluida-landing-page .lp-posts-inside 		{ max-width: <?php echo esc_html( $fluida_sitewidth - $sidebarS - $sidebarP ) ?>px;	}
...
.lp-block-content:before { background-color: <?php echo esc_html( $fluida_accent2 ); ?>; }
.lp-block-text { color: <?php echo esc_html( cryout_hexdiff( $fluida_sitetext, 50 ) ) ?>; }
